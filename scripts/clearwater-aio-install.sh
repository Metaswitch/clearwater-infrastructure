...
sed --follow-symlinks -e 's/#MAX_HEAP_SIZE=".*"/MAX_HEAP_SIZE="512M"/g' -i /etc/cassandra/cassandra-env.sh
sed --follow-symlinks -e 's/#HEAP_NEWSIZE=".*"/HEAP_NEWSIZE="128M"/g' -i /etc/cassandra/cassandra-env.sh
