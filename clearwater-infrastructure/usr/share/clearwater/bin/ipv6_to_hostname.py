...
if len(sys.argv) == 2:
    ...
    # try to use this as a hostname.
    print >> sys.stderr, "Usage : ipv6_to_homstname.py <IP address>"
    sys.exit(1)
...
try:
    ...
    print >> sys.stderr, "Invalid IP address %s" % ip_address
    sys.exit(1)
...
hostname_string = ".".join(reversed(ascii_address))
